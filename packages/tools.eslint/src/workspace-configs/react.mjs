...
import { REACT_ESLINT_CONFIG } from "../base-configs/react.mjs";
...
/**
 * React workspace eslint configuration.
 */
export const REACT_WORKSPACE_ESLINT_CONFIG = createEslintConfig(
  ESLINT_CONFIG,
